          ...
          var __webpack_modules__ = [
              ...
              var Rive = (() => {
                ...
                return (function(moduleArg = {}) {
                    ...
                    this.Fb = function(g) {
                      ...
                      e = new function() {
                        ...
                        this.Hb = function() {
                          ...
                          n ? (++h, m -= n, 1e3 < m && (g(1e3 * h / m), h = n = 0)) : (n = m, h = 0);
                        };
                      }();
                    };
                    this.Cb = function() {
                  ...
                  k.onRuntimeInitialized = function() {
                    ...
                    k.computeAlignment = function(f, g, h, n, m = 1) {
                  ...
                  const la = "createConicGradient createImageData createLinearGradient createPattern createRadialGradient getContextAttributes getImageData getLineDash getTransform isContextLost isPointInPath isPointInStroke measureText".split(" "), ma = new function() {
                    function a() {
                      if (!b) {
                        ...
                        q = new Proxy(q, { get(H, v) {
                          if (H.isContextLost()) {
                            if (n || (console.error("Cannot render the mesh because the GL Context was lost. Tried to invoke ", v), n = true), "function" === typeof H[v]) {
                              return function() {
                              };
                            }
                          } else {
                          ...
                          if (H.isContextLost()) {
                            n || (console.error("Cannot render the mesh because the GL Context was lost. Tried to set property " + v), n = true);
                          } else {
                            return H[v] = K, true;
                          }
                        } });
                    ...
                    let b = null, c = 0, d = 0, e = null, f = null, g = 0, h = 0, n = false;
                    a();
                    this.Tb = function() {
                      a();
                      return d;
                      ...
                      if (a()) {
                        ...
                        if (b.canvas) {
                          ...
                          for (const J of q) {
                            ...
                            J.Yb ? (b.scissor(J.Ra, K - J.Sa - J.ab, J.kc, J.ab), U = true) : U && (b.scissor(0, K - t, l, t), U = false);
                            q = 2 / l;
                            const Z = -2 / t;
                            ...
                            b.vertexAttribPointer(1, 2, b.FLOAT, false, 0, v + 4 * C);
                  ...
                  k.onRuntimeInitialized = function() {
                    ...
                    var t = k.RenderImage.extend("CanvasRenderImage", { __construct: function({ ha: p, sa: u } = {}) {
                      ...
                      this.fa = { ob: p, pb: u, Va: I, Wa: F, Ja: [], Sb: true };
                    ...
                    k.RendererWrapper.prototype.align = function(p, u, I, F, z = 1) {
                  ...
                  var Ca, Da = false, y, A, Ea, Ha, B, E, Ia, Ja;
                  function Ka() {
                    var a = Ca.buffer;
                  ...
                  var Za, $a, db = { 487293: (a, b, c, d, e) => {
                    ...
                    "undefined" !== typeof window.miniaudio && (window.miniaudio.unlock_event_types.map(function(a) {
                      document.removeEventListener(a, window.miniaudio.unlock, true);
                    ...
                    a != window.miniaudio.device_type.capture && a != window.miniaudio.device_type.duplex || navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(function(n) {
                  ...
                  function Bb(a, b) {
                    ...
                    c >= b || (b = Math.max(b, c * (1048576 > c ? 2 : 1.125) >>> 0), 0 != c && (b = Math.max(b, 256)), c = a.j, a.j = new Uint8Array(b), 0 < a.u && a.j.set(c.subarray(0, a.u), 0));
                  }
                  var N = { L: null, S() {
                    ...
                    b && (c |= 146);
                    return c;
                  }, Hb = null, Ib = {}, Jb = [], Kb = 1, Lb = null, Mb = true, M = class {
                    constructor(a) {
                  ...
                  function Pb(a, b = {}) {
                    ...
                    b = Object.assign({ Za: true, Ia: 0 }, b);
                    if (8 < b.Ia) {
                      throw new M(32);
                    }
                  ...
                  function ic(a, b, c) {
                    ...
                    if (b & 512 && !d) {
                      c = e;
                      c = "string" == typeof c ? Pb(c, { Ya: true }).node : c;
                      if (!c.i.N) {
                        throw new M(63);
                      }
                    ...
                    b &= -131713;
                    e = Xb({ node: e, path: Rb(e), flags: b, seekable: true, position: 0, l: e.l, jc: [], error: false });
                    e.l.open && e.l.open(e);
                  ...
                  var nc, oc = {}, jc, gb = void 0, pc = (a, b) => Object.defineProperty(b, "name", { value: a }), qc = [], rc = [], O, P = (a) => {
                    ...
                    b.count = { value: 1 };
                    return Mc(Object.create(a, { g: { value: b, writable: true } }));
                  }, Mc = (a) => {
                  ...
                  var gd = (a, b, c) => {
                    ...
                    function c(f) {
                      e[f] || Bc[f] || (Sc[f] ? Sc[f].forEach(c) : (d.push(f), e[f] = true));
                    }
                    var d = [], e = {};
                    b.forEach(c);
                  ...
                  var de = { __syscall_fcntl64: function(a, b, c) {
                    ...
                    T([a, b, c], d ? [d] : [], (t) => {
                      ...
                      q = new fd(r, v, true, false, false);
                      K = new fd(r + "*", v, false, false, false);
                      C = new fd(r + " const*", v, false, true, false);
                    ...
                    c = R(c);
                    Tc(a, { name: c, fromWireType: d, argPackAdvance: 8, readValueFromPointer: d }, { Nb: true });
                    ...
                    b = R(b);
                    Tc(a, { Dc: true, name: b, argPackAdvance: 0, fromWireType: () => {
                    }, toWireType: () => {
                    } });
                  ...
                  function je() {
                    function a() {
                      if (!he && (he = true, k.calledRun = true, !Da)) {
                        k.noFSInit || lc || (lc = true, k.stdin = k.stdin, k.stdout = k.stdout, k.stderr = k.stderr, k.stdin ? mc("stdin", k.stdin) : hc("/dev/tty", "/dev/stdin"), k.stdout ? mc("stdout", null, k.stdout) : hc("/dev/tty", "/dev/stdout"), k.stderr ? mc("stderr", null, k.stderr) : hc("/dev/tty1", "/dev/stderr"), ic("/dev/stdin", 0), ic("/dev/stdout", 1), ic("/dev/stderr", 1));
                        Mb = false;
                        eb(Ma);
                        ba(k);
            ...
            ((__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
              ...
              var SemanticState = {
                ...
                // requires Checkable
                Mixed: 1 << 3,
                // requires Checkable; wins over Checked
                Toggled: 1 << 4,
                // requires Toggleable
                Required: 1 << 5,
                // requires Requirable
...
//# sourceMappingURL=@rive-app_canvas.js.map
